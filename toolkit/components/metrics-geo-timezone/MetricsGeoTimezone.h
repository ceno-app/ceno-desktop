...
#ifndef mozilla_nsMetricsGeoTimezone_h__
#define mozilla_nsMetricsGeoTimezone_h__

// This will pull in the header auto-generated by the .idl file:
// {obj-directory}/dist/include/nsIComponentName.h
#include "nsIMetricsGeoTimezone.h"
...
// `mozilla` namespace.
class MetricsGeoTimezone final : public nsIMetricsGeoTimezone {
  ...
  NS_DECL_NSIMETRICSGEOTIMEZONE

 public:
  MetricsGeoTimezone() = default;
