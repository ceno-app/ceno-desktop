...
community-exp = <label data-l10n-name="community-exp-mozillaLink">{ -vendor-short-name }</label>  is a not-for-profit organization developing technologies to promote digital and community resilience, especially in environments threatened by censorship, surveillance, and network isolation.
